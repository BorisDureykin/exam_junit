...
public class Login extends EdujiraIfellowRuLogin {
    ...
    @Step("Проверка ошибки авторизации и сообщения об ошибке: 'Извините, имя пользователя или пароль неверны - пожалуйста, попробуйте еще раз.'")
    public static void invalidAuthorization() {
        ...
        saveScreenshot("Проверка ошибки авторизации и сообщения об ошибке: 'Извините, имя пользователя или пароль неверны - пожалуйста, попробуйте еще раз.'");
    }
}
